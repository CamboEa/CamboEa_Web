...
export function AdminEaBotCreateForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!file) {
      toast.error('សូមជ្រើសរើសឯកសារ Bot។');
      return;
    }
    ...
    try {
      ...
      if (!res.ok) {
        toast.error(json.error || 'បន្ថែម Bot មិនបាន');
        return;
      }

      toast.success('បន្ថែម Bot បានជោគជ័យ');
      router.push('/admin/ea-bot');
      router.refresh();
    } finally {
      setSaving(false);
    }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          បន្ថែមឯកសារ EA Bot ថ្មី និងទិន្នន័យពាក់ព័ន្ធ។
        </p>
      </div>
      ...
      >
        <div>
          ...
          <input
            ...
            placeholder="ឧ. CamboEA Scalper v2"
        ...
        <div className="flex justify-end gap-2">
          ...
          >
            {saving ? 'កំពុងរក្សាទុក...' : 'រក្សាទុក Bot'}
          </button>
        </div>
      </form>
    </div>
